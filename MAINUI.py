...
################################################################################
## Form generated from reading UI file 'MAINPAGE_UIwnqaIj.ui'
##
...
"margin:1px;\n"
"}\n"
"#CPU_btn,#Disk_btn,#GPU_btn,#RAM_btn,#System_info,#Wifi_btn,#act_btn,#battery_btn,#sensor_btn{\n"
...
"}")
        ...
        icon4 = QIcon()
        icon4.addFile(u":/menu/icons/menu/disk.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/black/icons/black/activity.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/black/icons/black/battery-charging.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/black/icons/black/cpu.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/black/icons/black/monitor.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/menu/icons/menu/ram.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/black/icons/black/wifi.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        icon13 = QIcon()
        icon13.addFile(u":/black/icons/black/refresh-cw.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.refresh_btn.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/black/icons/black/search.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.search.setIcon(icon14)
